...
function hasEmail(user) {
  ...
  return user.email !== null && user.email !== '' && user.email.length !== 0;
}
...
function hasProperty(object, property) {
  ...
  // otherwise return false
  return object[property] !== null && object[property] !== '' && object[property].length !== 0;
}
...
function sumUserPostLikes(user) {
  ...
  // return the sum
  var sum = 0;
  user.posts.forEach(function(item, index){
...
function addCalculateDiscountPriceMethod(storeItem) {
  ...
  //FUNCIONA: se agrega el metodo y retorna el valor, el npm test falla
